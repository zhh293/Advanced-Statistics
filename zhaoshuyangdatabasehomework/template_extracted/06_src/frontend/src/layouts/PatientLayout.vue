<template>
  <el-container class="app-layout">
    ...
    <el-aside width="220px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router background-color="#1a3c6e"
        text-color="#c8d8f0" active-text-color="#ffffff">
        <el-menu-item index="/patient/home">
          <el-icon><Search /></el-icon><span>找医生 / 预约</span>
        </el-menu-item>
        <el-menu-item index="/patient/appointments">
          <el-icon><Calendar /></el-icon><span>我的预约</span>
        </el-menu-item>
        <el-menu-item index="/patient/records">
          <el-icon><Document /></el-icon><span>就诊记录</span>
        </el-menu-item>
    ...
    <el-container>
      <el-header class="top-bar">
        <span class="welcome">你好，{{ auth.user?.username }}</span>
